...
public sealed class Commands
{
	...
	public unsafe void Set<T>(EntityID id) where T : unmanaged, ITag
	{
	...
	public unsafe void Set<TKind>(EntityID id, EntityID target) where TKind : unmanaged, IComponentStub
	{
